    ...
    path.addEventListener("click", function () {  
      ...
      moreInfoButton.addEventListener("click", () => {  
        ...
        const exaplinedMuscles = {
          quads: "Located at the front of the thigh, the quadriceps extend the knee and assist in hip flexion, essential for walking, running, and jumping. Strengthening them improves knee stability and power. Key exercises: squats, lunges, leg press, leg extensions.",  
        calves: "The calves (gastrocnemius, soleus) at the back of the lower leg control plantar flexion and provide stability for walking and running. Strong calves enhance endurance and balance. Key exercises: calf raises, donkey calf raises, jump rope.",  
        abdominals: "Located in the front torso, abs flex the spine, stabilize the core, and support posture. A strong core improves athletic performance and prevents back pain. Key exercises: crunches, planks, leg raises, Russian twists.",  
        obliques: "Situated on the sides of the torso, obliques assist in trunk rotation and lateral flexion, enhancing stability and balance. Key exercises: side planks, Russian twists, woodchoppers.",  
        hands: "Hand muscles control grip strength and dexterity, crucial for lifting and fine motor tasks. Key exercises: farmer's carries, grip squeezes, towel hangs.",  
        forearms: "Located between the wrist and elbow, forearms support grip strength and wrist stability. Key exercises: wrist curls, reverse curls, hammer curls.",  
        biceps: "Situated at the front of the upper arm, biceps assist in elbow flexion and pulling movements. Key exercises: bicep curls, hammer curls, chin-ups.",  
        "front-shoulders": "Located at the front of the shoulder, this muscle aids in shoulder flexion and pressing motions. Key exercises: shoulder presses, front raises, upright rows.",  
        chest: "Positioned in the upper torso, pecs assist in pushing movements and arm adduction. Key exercises: bench press, push-ups, dips, cable flys.",  
        traps: "Running from the neck to shoulders, traps elevate and retract the shoulders, improving posture. Key exercises: shrugs, upright rows, face pulls.",  
        hamstrings: "Located at the back of the thigh, hamstrings flex the knee and extend the hip, improving speed and power. Key exercises: Romanian deadlifts, leg curls, glute-ham raises.",  
        glutes: "The largest muscles in the body, the glutes aid in hip extension, stability, and lateral movement. Key exercises: squats, hip thrusts, lunges, deadlifts.",  
        triceps: "Situated at the back of the upper arm, triceps extend the elbow and enhance pushing strength. Key exercises: triceps dips, skull crushers, pushdowns.",  
        ...
        lowerback: "Supporting spinal stability and posture, the lower back muscles prevent injury and enhance strength. Key exercises: deadlifts, back extensions, good mornings.",  
        "traps-middle": "Located between the shoulder blades, these muscles aid in scapular retraction and posture. Key exercises: face pulls, rows, reverse flys.",  
        "rear-shoulders": "At the back of the shoulder, this muscle supports shoulder extension and rotation. Key exercises: reverse flys, face pulls, rear delt rows.",  
